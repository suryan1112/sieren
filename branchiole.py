...
def branchwise_sgpa(addmission_year,branch,semester,section=None,sorted=True,force_full=False):
    ...
    if branch is None: 
        ...
        return     
    file_name=file_name_creater(semester,addmission_year,sorted,branch,section,category='SGPA')
...
def complete_branch(last_year,branch,last_year_semester,section=None,sorted=True,force_full=False):
    ...
    if branch is None: 
        print('Incorrect Branch ❌')
        return     
    file_name=create_file_name(branch,sorted,section,category='SGPA')
